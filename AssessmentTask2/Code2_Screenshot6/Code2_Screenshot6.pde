...
// CODE2 SCREENSHOT6: Code can be changed from a wavy line to a growing form which regenerates at every click by pressing 1 or 2. The stroke of the form is randomised shades from black to white. 
 ...
 * 
 * MOUSE
 * click               : start/activate a new form
 * position x/y        : direction and speed of floating
 * 
 * KEYS
 * 1-2                 : form styles- remain linear(1) or gradually grow in form(2)
 * 3-4                 : 
